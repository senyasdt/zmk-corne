...
static void draw_battery_widget(lv_obj_t *widget, const struct status_state *state) {
...
static void set_battery_status(struct zmk_widget_status *widget,
    ...
    draw_battery_widget(widget->obj, &widget->state);
}
...
int zmk_widget_status_init(struct zmk_widget_status *widget, lv_obj_t *parent) {
    ...
    set_battery_status(widget, battery_status_get_state(NULL));
